...
<head>
    ...
    <title>Fat Touré - Entrepreneur Immobilier</title>
...
<body>
        ...
        <div class="w-full md:w-1/2 flex flex-col justify-between p-6 md:p-16 relative bg-white">
            ...
            <div class="flex-grow flex items-center justify-start md:justify-center py-12 md:py-0">
                <div class="relative w-full max-w-lg md:max-w-none">
                    ...
                    <div class="absolute -bottom-10 md:-bottom-24 left-1/3 md:left-1/2 transform -translate-x-1/4">
                        <span class="font-script text-6xl md:text-8xl lg:text-9xl text-custom-red -rotate-12 block">Entrepreneur Immobilier</span>
                    </div>
                </div>
            </div>
    ...
    <section class="py-16 px-4 md:py-32 md:px-24">
