            ...
            <div class="flex-grow flex items-center justify-start md:justify-center py-12 md:py-0">
                <div class="relative w-full max-w-lg md:max-w-none">
                    ...
                    <div class="absolute -bottom-6 md:-bottom-20 left-1/3 md:left-1/2 transform -translate-x-1/4">
                        <span class="font-script text-6xl md:text-8xl lg:text-9xl text-custom-red -rotate-12 block">Modèle</span>
                    </div>
                </div>
            </div>
    ...
    <section class="hidden md:block py-16 px-4 md:py-32 md:px-0 bg-white" id="teasers">
        <div class="container mx-auto px-4 max-w-7xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mb-16">
                ...
                <div class="bg-white rounded-[30px] overflow-hidden shadow-lg border border-gray-100 group">
                    <div class="relative aspect-square">
                        ...
                        <div class="absolute bottom-6 right-6">
                            <a href="{{ $teaser->video_url }}" class="w-16 h-16 bg-[#00818a] rounded-full flex items-center justify-center text-white shadow-xl hover:scale-110 transition-transform duration-300">
            ...
            <div class="flex items-center justify-center gap-8">
                <button class="text-red-600 hover:scale-125 transition-transform">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"></path>
                    </svg>
                </button>
                <div class="w-64 h-[2px] bg-gray-200 relative">
                    <div class="absolute left-0 top-0 h-full w-1/3 bg-gray-900"></div>
                </div>
                <button class="text-red-600 hover:scale-125 transition-transform">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
